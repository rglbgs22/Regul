                    ...
                    <form action="<?= site_url('customer/check/'.$this->uri->segment(3)) ?>" method="POST">
                            ...
                            <?php foreach($data->result() as $row)$status = $row->status;?>
                                    <?php
                                        if ($status == 0) {
                                            ...
                                            ?>
                                            <div class="w-100 d-flex justify-content-center">
                                                <svg version="1.1" width="200px" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                        ...
                        <div class="card-footer">
                            <div class="d-flex justify-content-end">
                                <div>
                                    <button type="submit" class="btn btn-warning rounded">Check</button>
                                </div>
                            </div>
                        </div>
                    </form>
